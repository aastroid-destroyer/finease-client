    ...
    return (
        <StyledWrapper>
            <div className="card">
                ...
                <div className="box box2"> <span className="icon"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="svg">
                ...
                <div className="box box3"><span className="icon"><svg viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg" className="svg">
...
const StyledWrapper = styled.div`
  ...
  .background {
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at 100% 107%, #8b2f97 0%, #4a2d7e 30%, #2a3f5f 60%, #1a365d 100%);
  }
  ...
  .box1::before {
    background: radial-gradient(circle at 30% 107%, #f58529 0%, #dd2a7b 60%, #8134af 90%);
  }
  ...
  .box2::before {
    background: radial-gradient(circle at 30% 107%, #1da1f2 0%, #0e71c8 90%);
  }
  ...
  .box3::before {
    background: radial-gradient(circle at 30% 107%, #7289da 0%, #5a6ebf 90%);
  }
